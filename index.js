...
document.addEventListener('readystatechange', event => { // When HTML/DOM elements are ready:
    ...
    if (event.target.readyState === "complete") { // alert("hi 2");
        const CONFIG = {
            /**
     ...
     */
            commands: [
                ...
                },
                {
                    ...
                    search: '/search?q={}',
                    color: 'linear-gradient(135deg, #ff4500, #ff4500 15%, #cee3f8 15%, #cee3f8 85%, #5f99cf 85%)'
                }, {
                    category: 'Social',
                    name: 'VozForums',
                    key: 'voz',
                    ...
                    search: '',
                    color: 'linear-gradient(135deg, #0cb3ff, #0068ff)'
                }, {
                    category: 'eCommerce',
                    name: 'Techcombank',
                    key: 'tcb',
                    ...
                    search: '',
                    color: 'linear-gradient(135deg, rgb(237, 33, 58), rgb(147, 41, 30))'
                }, {
                    category: 'eCommerce',
                    name: 'VPBank',
                    key: 'vp',
                    url: 'https://neo.vpbank.com.vn/',
                    search: '',
                    color: 'linear-gradient(90deg,#015aad,#00b74f)'
                }, {
                    category: 'eCommerce',
                    name: 'Shopee',
                    key: 'shopee',
                    ...
                    name: 'VnDirect',
                    key: 'vnd',
                    url: 'https://trade.vndirect.com.vn/chung-khoan/danh-muc',
                    search: '',
                    ...
                    search: '',
                    color: 'linear-gradient(to right, #2980b9, #6dd5fa, #ffffff)'
                }
            ],
     ...
     */
            defaultSuggestions: {
                g: [
                    'g/issues', 'g/pulls', 'gist.github.com'
                ],
                l: [
                    'l/#electronic+chill', 'l/#focus+instrumental', 'l/#piano+sleep'
                ],
                r: [
